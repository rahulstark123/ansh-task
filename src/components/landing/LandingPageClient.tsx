...
const SOCIAL_LINKS = [
  {
    ...
    Icon: FacebookIcon,
    className:
      "text-[#1877F2] hover:bg-[#1877F2]/10 dark:text-[#1877F2] dark:hover:bg-[#1877F2]/15",
  },
  {
    name: "Instagram",
    ...
    Icon: InstagramIcon,
    className:
      "text-[#E4405F] hover:bg-[#E4405F]/10 dark:text-[#E4405F] dark:hover:bg-[#E4405F]/15",
  },
  {
    name: "YouTube",
    href: "https://www.youtube.com/@anshapps",
    Icon: YouTubeIcon,
    className:
      "text-[#FF0000] hover:bg-[#FF0000]/10 dark:text-[#FF0000] dark:hover:bg-[#FF0000]/15",
  },
] as const;
...
const PRICING_PLANS = [
  {
    ...
    features: [
      ...
      { label: "20 AI Credits per month", included: true },
      { label: "Brain Board included", included: true },
      { label: "Mobile app soon", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "100 AI Credits included", included: true },
      { label: "Brain Board included", included: true },
      { label: "Mobile app soon", included: true },
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 pt-1">
                  {SOCIAL_LINKS.map(({ name, href, Icon, className }) => (
                    <a
                      key={name}
                      href={href}
                      target="_blank"
